...
Bool loadGLTextures(GLuint *myTex, char *strFileName)   /* Load Bitmaps And Convert To Textures */
{
    Bool status;
    textureImage *texti;
    ...
    if (loadBMP(strFileName, texti))
    {
        status = True;
        glGenTextures(1, myTex);   /* create the texture */
